...
def main(args):
    ...
    # )
    toxigen_roberta_tokenizer = AutoTokenizer.from_pretrained(args.toxigen_classifier_path)
    toxigen_roberta_classifier = AutoModelForSequenceClassification.from_pretrained(
        args.toxigen_classifier_path
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--toxigen_classifier_path",
        type=str,
        default=None,
        help="should specified, we will load the tokenizer and model from here.",
    )
    parser.add_argument(
        "--use_slow_tokenizer",
        action="store_true",
